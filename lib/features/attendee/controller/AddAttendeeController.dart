...
class AddAttendeeController extends GetxController {
 ...
 // Rx<TextEditingController>  sitesController = TextEditingController().obs;
  ...
  RxString attendeeType = "Plumber".obs;
  List<String> attendeeTypeOptions = ["Plumber", "Contractor"];
  ...
  validateAndProcess() async {
    ...
    // else if (attendeeType =="Plumber"&&ShopnameController.value.text.trim().isEmpty) {
    //   AppUtils.showSnackbar(Get.context!,"Please enter shop name", "Info");
    // } else if ( attendeeType =="Plumber"&&ShopLocationController.value.text.trim().isEmpty) {
    ...
    else if ( attendeeType !="Plumber" && selectedTeamSize.value.isEmpty) {
      AppUtils.showSnackbar(Get.context!,"Please enter Team Size", "Info");
    } else if (attendeeType !="Plumber" && selectedSitePerMonth.value.isEmpty) {
  ...
  Future<void> CallNoteAdd_update() async {
    ...
    var requestBody = {
      ...
      "fld_contractor": attendeeType=="Plumber"?0:1,
      //participantOption.value=="Yes"&& Contractoroption.value=="Yes"?1:0,
      "fld_contractor_team_size": attendeeType!="Plumber"?selectedTeamSize.value:"",
      "fld_contractor_sites": attendeeType!="Plumber"?selectedSitePerMonth.value:"",
      //participantOption.value=="Yes"&& Contractoroption.value=="Yes"?sitesController.value.text:"",
      "fld_smartphone": smartphoneOption.value=="Yes"?1:0,
      "fld_app_download_nebula": smartphoneOption.value=="Yes" && DownloadApp.value=="Yes"?1:0,
